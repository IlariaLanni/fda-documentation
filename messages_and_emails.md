...
Click [here](http://docs.frontdeskanywhere.net/build/application_resources.html) to have a full list of al the variables available for template customization!
